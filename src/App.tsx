...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: '/pipelines/:name/edit', element: <PipelineEditor /> },
      { path: '/pipelines/:name/versions', element: <Versions /> },
      { path: '/subscriptions', element: <Subscriptions /> },
      { path: '/subscriptions/new', element: <SubscriptionEditor /> },
      { path: '/subscriptions/:name/edit', element: <SubscriptionEditor /> },
